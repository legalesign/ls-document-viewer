...
| `manager`           | `manager`       |             | `"document" \| "participant" \| "recipient" \| "toolbox" \| "validation"`                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | `undefined` |
...
| `managerChange` |             | `CustomEvent<"document" \| "participant" \| "recipient" \| "toolbox" \| "validation">` |
