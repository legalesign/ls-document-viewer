...
| `password`        | `password`        | The password of the account your want the widget to use. {string}                                                                                      | `string`                                   | `undefined`          |
...
| `username`        | `username`        | The username of the account your want the widget to use. {string}                                                                                      | `string`                                   | `undefined`          |
