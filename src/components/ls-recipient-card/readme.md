...
| `fieldTypeSelected` | --                 |                                                                                                                                                        | `IToolboxField`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | `{     label: 'Signature',     formElementType: 'signature-icon',     elementType: 'signature-icon',     validation: 0,     defaultHeight: 27,     defaultWidth: 120,   }` |
