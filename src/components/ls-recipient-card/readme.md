...
| `recipient`         | --                 | The initial template data, including the link for background PDF. See README and example for correct GraphQL query and data structure. {LSApiTemplate} | `{ name: string; email: string; firstname: string; lastname: string; signerIndex?: number; phone?: string; roleType?: "SIGNER" \| "APPROVER" \| "WITNESS" \| "FORM_FILLER"; }`                                                                                                                                                                                                                                                                                                                                                               | `undefined`                                                                                                                                                      |
