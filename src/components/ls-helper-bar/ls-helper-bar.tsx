      ...
      <Host>
        <div class={'ls-dv-controls-bar'} onMouseEnter={() => (this.expanded = true)} onMouseLeave={() => (this.expanded = false)}>
          ...
          <button
            ...
            onClick={() => window.open('https://docs.legalesign.com/web-app/how-to/useedit', '_blank')}
            data-tooltip-id="ls-dv-tooltip"
            data-tooltip-html={`<span style="white-space:nowrap">${dvI18n.t('helperbar.viewdocumentation')}</span>`}
            data-tooltip-place={this.isSafari ? 'top' : 'left'}
          >
          ...
          <button
            ...
            onClick={() =>
              window.open(
                window.location.hostname.includes('legalesign.io') || window.location.hostname === 'localhost'
                  ? 'https://support.legalesign.io/tickets'
                  : 'https://support.legalesign.com/tickets',
                '_blank',
              )
            }
            data-tooltip-id="ls-dv-tooltip"
            data-tooltip-html={`<span style="white-space:nowrap">${dvI18n.t('helperbar.contactsupport')}</span>`}
            data-tooltip-place={this.isSafari ? 'top' : 'left'}
          >
